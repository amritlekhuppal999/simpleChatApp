    ...
    // Non Empty Page array
        ...
        // PUBLIC RESOURCE
            ...
            if(page_view_2 == 'js'){
                ...
                // CHATROOM
                if(page_view_3 == "chatroom.js"){
                    return_page = path.join(ROOT_DIR, path_var1, path_var2, 'chatroom.js');
                }
                ...
                // 404 
                    ...
                    return_page = path.join(ROOT_DIR, 'views', '404.html');
                    status_code = 404;
                    console.log("JS Error!!", "Requested JS file '"+page_view_3+"' not found!");
                }
            }

            // CSS
            else if(page_view_2 == 'css'){
                let page_view_3 = requested_page_array[2];
                let path_var2 = "css";
                contentType = "text/css";

                // CHATROOM
                if(page_view_3 == "chatroom.css"){
                    return_page = path.join(ROOT_DIR, path_var1, path_var2, 'chatroom.css');
                }

                else {
                    return_page = path.join(ROOT_DIR, 'views', '404.html');
                    status_code = 404;
                    console.log("CSS Error!!", "Requested CSS file '"+page_view_3+"' not found!");
                }
            }

            // IMAGES
            else if(page_view_2 == 'images'){
                let page_view_3 = requested_page_array[2];
                let path_var2 = "images";
            ...
            // 404
                ...
                return_page = path.join(ROOT_DIR, 'views', '404.html');
                status_code = 404;
                console.log("Public Resource Error!!", "Requested RESOURCE file '"+page_view_2+"' not found!");
            }
        }
